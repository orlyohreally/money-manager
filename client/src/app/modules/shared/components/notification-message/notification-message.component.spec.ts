...
describe('ErrorMessageComponent', () => {
  ...
  it('should display block with class .notification-message.notification-message_info when type is info', () => {
    component.type = 'info';
    fixture.detectChanges();
  ...
  it('should display block with class .notification-message.notification-message_info when type is not set', () => {
    const notificationEl: HTMLElement = fixture.nativeElement.querySelector(
      '.notification-message'
    );
    expect(notificationEl).toBeTruthy();
  ...
  it('should display block with class .notification-message.notification-message_error when type is error', () => {
  ...
  it('should display block with class .notification-message.notification-message_success when type is success', () => {
